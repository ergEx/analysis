...
def read_active_data_to_dict(root_path:str,
    ...
    for dynamic in dynamics:
        ...
        for subject in subject_numbers:
            ...
            datadict.setdefault('w1_1'+dynamic_specs[dynamic]['txt_append'],[]).append(wealth_change(np.array(subject_df['wealth']), np.array(subject_df['gamma_left_up']), dynamic_specs[dynamic]['lambd']))
            datadict.setdefault('w1_2'+dynamic_specs[dynamic]['txt_append'],[]).append(wealth_change(np.array(subject_df['wealth']), np.array(subject_df['gamma_left_down']), dynamic_specs[dynamic]['lambd']))
            datadict.setdefault('w2_1'+dynamic_specs[dynamic]['txt_append'],[]).append(wealth_change(np.array(subject_df['wealth']), np.array(subject_df['gamma_right_up']), dynamic_specs[dynamic]['lambd']))
            datadict.setdefault('w2_2'+dynamic_specs[dynamic]['txt_append'],[]).append(wealth_change(np.array(subject_df['wealth']), np.array(subject_df['gamma_right_down']), dynamic_specs[dynamic]['lambd']))

            datadict.setdefault('w'+dynamic_specs[dynamic]['txt_append'],[]).append(np.array(subject_df['wealth']))
